<?php
include("crud4.php"); // Asegúrate de que crud4.php incluya la función obtenerRegistros
        ...
        <tbody>
            <?php foreach ($registros as $registro): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($registro['Fecha'] ?? 'No especificado') ?></td>
                    <td><?php echo htmlspecialchars($registro['Color'] ?? 'No especificado') ?></td>
                    <td><?php echo htmlspecialchars($registro['Conectores'] ?? 'No especificado') ?></td>
                    <td><?php echo htmlspecialchars($registro['Aula'] ?? 'No especificado') ?></td>
                    <td><?php echo htmlspecialchars($registro['Archivo'] ?? 'No especificado') ?></td>
                    ...
                    <td><?php echo htmlspecialchars($registro['Direccion'] ?? 'No especificado') ?></td>
                    <td>

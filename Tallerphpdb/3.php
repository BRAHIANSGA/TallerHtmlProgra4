<?php
include("crud3.php"); // Asegúrate de que crud1.php incluya la función obtenerRegistros
    ...
    <table border="1">
        ...
        <tbody>
            <?php foreach ($registros as $registro): ?>
                <tr>
                    <td><?php echo htmlspecialchars($registro['Ciclo'] ?? 'No especificado') ?></td>
                    <td><?php echo htmlspecialchars($registro['Fecha'] ?? 'No especificado') ?></td>
                    <td><?php echo htmlspecialchars($registro['Texto1'] ?? 'No especificado') ?></td>
                    ...
                    <td><?php echo htmlspecialchars($registro['Escritorio'] ?? 'No especificado') ?></td>
                    ...
                    <td><?php echo htmlspecialchars($registro['Telefono'] ?? 'No especificado') ?></td>
                    <!-- Botones de Acción -->
                    <td>
                        <!-- Botón de Actualizar -->

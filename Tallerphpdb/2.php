        ...
        <table border="1">
            ...
            <tbody>
                <?php foreach ($registros as $registro): ?>
                    <tr>
                        <td>
                            <?php echo htmlspecialchars($registro['Asignatura'] ?? 'No especificado') ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['EditorDeTexto'] ?? 'No especificado') ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['Comentarios'] ?? 'No especificado') ?>
                        </td>
                        <td>

...
<body>
    ...
    <div style="border: 3px solid black; width: 90%; margin-left: 10%;">
            ...
            <tbody>
                <?php foreach ($registros as $registro): ?>
                    <tr>
                        ...
                        <td>
                            <?php echo htmlspecialchars($registro['Velocidad'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['DNI'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php echo htmlspecialchars($registro['Email'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php echo htmlspecialchars($registro['Procesador'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['Hora'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['Red'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['Fichero'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['Asignaturas'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['OtraHora'] ?? 'No especificado'); ?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($registro['OtroFichero'] ?? 'No especificado'); ?>
                        </td>
                        <td>
